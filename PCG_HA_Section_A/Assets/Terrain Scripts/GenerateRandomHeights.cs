...
public class GenerateRandomHeights : MonoBehaviour
{
    ...
    [SerializeField]
    [Range(0f, 1f)]
    private float maxRandomHeightRange = 0.01f; // max is 1
    ...
    [SerializeField]
    private float perlinNoiseHeightScale = 0.02f;
    ...
    private void AddRain()
    {
        ...
        rainGameObject.transform.position = this.transform.position + new Vector3(terrainData.size.x / 2, rainHeight * terrainData.size.y,
            terrainData.size.z / 2);
    }
